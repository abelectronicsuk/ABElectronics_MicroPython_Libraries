...
"""
================================================
AB Electronics UK IO Pi Zero | Digital I/O Read Demo for MicroPython Library
...
Create a file named demo_ioreadzero.py, copy the code from this file and save
